...
par(mfrow=c(2,2))
plot(saveframe4$E_val, saveframe4$B1/saveframe4$B0, xlab='E-value',ylab='Estimated ICRR',  main=expression(paste('Sharkfin q=0.75, s=1.25, ', sigma, '=0.88')))
plot(saveframe3$E_val, saveframe3$B1/saveframe3$B0, xlab='E-value',ylab='Estimated ICRR',  main=expression(paste('Sharkfin q=0.25, s=0.5, ', sigma, '=1.05')))
